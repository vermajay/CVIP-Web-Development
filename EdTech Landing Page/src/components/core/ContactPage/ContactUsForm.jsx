  ...
  return (
    <form onSubmit={handleSubmit(submitContactForm)} className='text-richBlack-5 text-sm leading-[22px] flex flex-col gap-7
     max-w-xl'>
        ...
        {/* submit button */}
        <button className={`bg-yellow-50 text-black hover:shadow-none hover:scale-95 transition-all duration-200'} shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)] text-center text-[16px] px-6 py-3 rounded-md font-bold w-full`}>
            Send Message
        </button>
